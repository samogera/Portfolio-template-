...
// Adjusted: use public images instead of non-existent assets directory
// You can place images at public/img and reference via "/img/..."
const reactNative = "/img/React_Native.png";
const mernStack = "/img/MERN_Stack.png";
